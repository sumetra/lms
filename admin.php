...
if(isset($_POST['login']) && $_POST['login'] == 'login')
{
  ...
  $result = $obj->Selectall("librarian","*","username",array($_POST['username'])," AND password=".$_POST['password']);
  ...
  {
    header('location:admin.php?please enter valid username and password');
  }
}
        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <p class="login-card-description">  PLEASE LOGIN </p>
              <form  method="post" >
